...
void pushMergedNeuronUpdateGroup0ToDevice(unsigned int idx, float* inSynInSyn5, float* denDelayInSyn2, unsigned int* denDelayPtrInSyn2, float* inSynInSyn3, float* denDelayInSyn3, unsigned int* denDelayPtrInSyn3, float* inSynInSyn4, float* denDelayInSyn4, unsigned int* denDelayPtrInSyn4, float* inSynInSyn2, float* denDelayInSyn5, unsigned int* denDelayPtrInSyn5, float* inSynInSyn6, float* denDelayInSyn6, unsigned int* denDelayPtrInSyn6, float* inSynInSyn7, float* denDelayInSyn7, unsigned int* denDelayPtrInSyn7, unsigned int* denDelayPtrInSyn1, unsigned int* spkCnt, unsigned int* spk, scalar* V, scalar* RefracTime, float* inSynInSyn0, float* denDelayInSyn0, unsigned int* denDelayPtrInSyn0, float* inSynInSyn1, float* denDelayInSyn1, scalar Rmembrane, scalar ExpTC, scalar Vreset, scalar Vrest, scalar TauM, scalar C, unsigned int numNeurons) {
    MergedNeuronUpdateGroup0 group = {inSynInSyn5, denDelayInSyn2, denDelayPtrInSyn2, inSynInSyn3, denDelayInSyn3, denDelayPtrInSyn3, inSynInSyn4, denDelayInSyn4, denDelayPtrInSyn4, inSynInSyn2, denDelayInSyn5, denDelayPtrInSyn5, inSynInSyn6, denDelayInSyn6, denDelayPtrInSyn6, inSynInSyn7, denDelayInSyn7, denDelayPtrInSyn7, denDelayPtrInSyn1, spkCnt, spk, V, RefracTime, inSynInSyn0, denDelayInSyn0, denDelayPtrInSyn0, inSynInSyn1, denDelayInSyn1, Rmembrane, ExpTC, Vreset, Vrest, TauM, C, numNeurons, };
...
__device__ __constant__ MergedNeuronUpdateGroup1 d_mergedNeuronUpdateGroup1[2];
void pushMergedNeuronUpdateGroup1ToDevice(unsigned int idx, float* denDelayInSyn7, float* inSynInSyn4, float* denDelayInSyn4, unsigned int* denDelayPtrInSyn4, float* inSynInSyn5, float* denDelayInSyn5, unsigned int* denDelayPtrInSyn5, float* inSynInSyn6, float* denDelayInSyn6, unsigned int* denDelayPtrInSyn6, float* inSynInSyn7, unsigned int* denDelayPtrInSyn3, unsigned int* denDelayPtrInSyn7, float* inSynInSyn8, float* denDelayInSyn8, unsigned int* denDelayPtrInSyn8, float* inSynInSyn9, float* denDelayInSyn9, unsigned int* denDelayPtrInSyn9, float* inSynInSyn10, float* denDelayInSyn10, unsigned int* denDelayPtrInSyn10, float* denDelayInSyn0, unsigned int* spkCnt, unsigned int* spk, scalar* V, scalar* RefracTime, float* inSynInSyn0, unsigned int* denDelayPtrInSyn0, float* inSynInSyn1, float* denDelayInSyn1, unsigned int* denDelayPtrInSyn1, float* inSynInSyn2, float* denDelayInSyn2, unsigned int* denDelayPtrInSyn2, float* inSynInSyn3, float* denDelayInSyn3, unsigned int numNeurons, scalar Rmembrane, scalar ExpTC, scalar Vrest, scalar TauM, scalar C) {
    MergedNeuronUpdateGroup1 group = {denDelayInSyn7, inSynInSyn4, denDelayInSyn4, denDelayPtrInSyn4, inSynInSyn5, denDelayInSyn5, denDelayPtrInSyn5, inSynInSyn6, denDelayInSyn6, denDelayPtrInSyn6, inSynInSyn7, denDelayPtrInSyn3, denDelayPtrInSyn7, inSynInSyn8, denDelayInSyn8, denDelayPtrInSyn8, inSynInSyn9, denDelayInSyn9, denDelayPtrInSyn9, inSynInSyn10, denDelayInSyn10, denDelayPtrInSyn10, denDelayInSyn0, spkCnt, spk, V, RefracTime, inSynInSyn0, denDelayPtrInSyn0, inSynInSyn1, denDelayInSyn1, denDelayPtrInSyn1, inSynInSyn2, denDelayInSyn2, denDelayPtrInSyn2, inSynInSyn3, denDelayInSyn3, numNeurons, Rmembrane, ExpTC, Vrest, TauM, C, };
...
void pushMergedNeuronUpdateGroup3ToDevice(unsigned int idx, unsigned int* denDelayPtrInSyn6, unsigned int* denDelayPtrInSyn3, float* inSynInSyn4, float* denDelayInSyn4, unsigned int* denDelayPtrInSyn4, float* inSynInSyn5, float* denDelayInSyn5, unsigned int* denDelayPtrInSyn5, float* inSynInSyn6, float* denDelayInSyn6, float* denDelayInSyn3, float* inSynInSyn7, float* denDelayInSyn7, unsigned int* denDelayPtrInSyn7, float* inSynInSyn8, float* denDelayInSyn8, unsigned int* denDelayPtrInSyn8, float* inSynInSyn9, float* denDelayInSyn9, unsigned int* denDelayPtrInSyn9, float* inSynInSyn0, unsigned int* spkCnt, unsigned int* spk, scalar* V, scalar* RefracTime, float* denDelayInSyn0, unsigned int* denDelayPtrInSyn0, float* inSynInSyn1, float* denDelayInSyn1, unsigned int* denDelayPtrInSyn1, float* inSynInSyn2, float* denDelayInSyn2, unsigned int* denDelayPtrInSyn2, float* inSynInSyn3, unsigned int numNeurons, scalar Rmembrane, scalar TauRefrac, scalar Ioffset, scalar Vreset, scalar C) {
    MergedNeuronUpdateGroup3 group = {denDelayPtrInSyn6, denDelayPtrInSyn3, inSynInSyn4, denDelayInSyn4, denDelayPtrInSyn4, inSynInSyn5, denDelayInSyn5, denDelayPtrInSyn5, inSynInSyn6, denDelayInSyn6, denDelayInSyn3, inSynInSyn7, denDelayInSyn7, denDelayPtrInSyn7, inSynInSyn8, denDelayInSyn8, denDelayPtrInSyn8, inSynInSyn9, denDelayInSyn9, denDelayPtrInSyn9, inSynInSyn0, spkCnt, spk, V, RefracTime, denDelayInSyn0, denDelayPtrInSyn0, inSynInSyn1, denDelayInSyn1, denDelayPtrInSyn1, inSynInSyn2, denDelayInSyn2, denDelayPtrInSyn2, inSynInSyn3, numNeurons, Rmembrane, TauRefrac, Ioffset, Vreset, C, };
...
void pushMergedNeuronUpdateGroup7ToDevice(unsigned int idx, float* inSynInSyn8, float* inSynInSyn4, float* denDelayInSyn4, unsigned int* denDelayPtrInSyn4, float* inSynInSyn5, float* denDelayInSyn5, unsigned int* denDelayPtrInSyn5, float* inSynInSyn6, float* denDelayInSyn6, unsigned int* denDelayPtrInSyn6, float* inSynInSyn7, float* denDelayInSyn7, unsigned int* denDelayPtrInSyn7, unsigned int* denDelayPtrInSyn3, float* denDelayInSyn8, unsigned int* denDelayPtrInSyn8, float* inSynInSyn9, float* denDelayInSyn9, unsigned int* denDelayPtrInSyn9, float* inSynInSyn10, float* denDelayInSyn10, unsigned int* denDelayPtrInSyn10, float* inSynInSyn11, float* denDelayInSyn11, unsigned int* denDelayPtrInSyn11, float* denDelayInSyn3, unsigned int* spkCnt, unsigned int* spk, scalar* V, scalar* RefracTime, float* inSynInSyn0, float* denDelayInSyn0, unsigned int* denDelayPtrInSyn0, float* inSynInSyn1, float* denDelayInSyn1, unsigned int* denDelayPtrInSyn1, float* inSynInSyn2, float* denDelayInSyn2, unsigned int* denDelayPtrInSyn2, float* inSynInSyn3, scalar Rmembrane, scalar ExpTC, scalar TauRefrac, scalar Ioffset, scalar Vreset, scalar Vrest, scalar TauM, scalar C, unsigned int numNeurons) {
    MergedNeuronUpdateGroup7 group = {inSynInSyn8, inSynInSyn4, denDelayInSyn4, denDelayPtrInSyn4, inSynInSyn5, denDelayInSyn5, denDelayPtrInSyn5, inSynInSyn6, denDelayInSyn6, denDelayPtrInSyn6, inSynInSyn7, denDelayInSyn7, denDelayPtrInSyn7, denDelayPtrInSyn3, denDelayInSyn8, denDelayPtrInSyn8, inSynInSyn9, denDelayInSyn9, denDelayPtrInSyn9, inSynInSyn10, denDelayInSyn10, denDelayPtrInSyn10, inSynInSyn11, denDelayInSyn11, denDelayPtrInSyn11, denDelayInSyn3, spkCnt, spk, V, RefracTime, inSynInSyn0, denDelayInSyn0, denDelayPtrInSyn0, inSynInSyn1, denDelayInSyn1, denDelayPtrInSyn1, inSynInSyn2, denDelayInSyn2, denDelayPtrInSyn2, inSynInSyn3, Rmembrane, ExpTC, TauRefrac, Ioffset, Vreset, Vrest, TauM, C, numNeurons, };
...
__device__ __constant__ unsigned int d_mergedNeuronUpdateGroupStartID1[] = {3712, 6336, };
__device__ __constant__ unsigned int d_mergedNeuronUpdateGroupStartID2[] = {8256, };
__device__ __constant__ unsigned int d_mergedNeuronUpdateGroupStartID3[] = {23808, 44096, };
__device__ __constant__ unsigned int d_mergedNeuronUpdateGroupStartID4[] = {48640, };
__device__ __constant__ unsigned int d_mergedNeuronUpdateGroupStartID5[] = {70272, };
...
extern "C" __global__ void updateNeuronsKernel(float t)
 {
    ...
    if(id >= 8256 && id < 23808) {
        ...
        const unsigned int lid = id - 8256;
        ...
        if(lid < group->numNeurons) {
            ...
            // calculate membrane potential
            if (lRefracTime <= 0.0f) {
              scalar alpha = ((Isyn + (5.00999987125396729e-01f)) * (2.00000000000000000e+02f)) + (-7.00000000000000000e+01f);
    ...
    if(id >= 70272 && id < 72064) {
        ...
        if(lid < group->numNeurons) {
            ...
            // calculate membrane potential
            if (lRefracTime <= 0.0f) {
              scalar alpha = ((Isyn + (5.00999987125396729e-01f)) * (5.00000000000000000e+01f)) + (-8.60000000000000000e+01f);
