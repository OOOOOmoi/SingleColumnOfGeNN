...
__device__ __constant__ MergedNeuronUpdateGroup1 d_mergedNeuronUpdateGroup1[5];
...
void pushMergedNeuronUpdateGroup9ToDevice(unsigned int idx, unsigned int* denDelayPtrInSyn8, float* denDelayInSyn5, unsigned int* denDelayPtrInSyn5, float* inSynInSyn6, float* denDelayInSyn6, unsigned int* denDelayPtrInSyn6, float* inSynInSyn7, float* denDelayInSyn7, unsigned int* denDelayPtrInSyn7, float* inSynInSyn8, float* denDelayInSyn8, float* inSynInSyn5, float* inSynInSyn9, float* denDelayInSyn9, unsigned int* denDelayPtrInSyn9, float* inSynInSyn10, float* denDelayInSyn10, unsigned int* denDelayPtrInSyn10, float* inSynInSyn11, float* denDelayInSyn11, unsigned int* denDelayPtrInSyn11, unsigned int* denDelayPtrInSyn1, unsigned int* spkCnt, unsigned int* spk, scalar* V, scalar* RefracTime, float* inSynInSyn0, float* denDelayInSyn0, unsigned int* denDelayPtrInSyn0, float* inSynInSyn1, float* denDelayInSyn1, float* inSynInSyn2, float* denDelayInSyn2, unsigned int* denDelayPtrInSyn2, float* inSynInSyn3, float* denDelayInSyn3, unsigned int* denDelayPtrInSyn3, float* inSynInSyn4, float* denDelayInSyn4, unsigned int* denDelayPtrInSyn4, unsigned int numNeurons) {
    MergedNeuronUpdateGroup9 group = {denDelayPtrInSyn8, denDelayInSyn5, denDelayPtrInSyn5, inSynInSyn6, denDelayInSyn6, denDelayPtrInSyn6, inSynInSyn7, denDelayInSyn7, denDelayPtrInSyn7, inSynInSyn8, denDelayInSyn8, inSynInSyn5, inSynInSyn9, denDelayInSyn9, denDelayPtrInSyn9, inSynInSyn10, denDelayInSyn10, denDelayPtrInSyn10, inSynInSyn11, denDelayInSyn11, denDelayPtrInSyn11, denDelayPtrInSyn1, spkCnt, spk, V, RefracTime, inSynInSyn0, denDelayInSyn0, denDelayPtrInSyn0, inSynInSyn1, denDelayInSyn1, inSynInSyn2, denDelayInSyn2, denDelayPtrInSyn2, inSynInSyn3, denDelayInSyn3, denDelayPtrInSyn3, inSynInSyn4, denDelayInSyn4, denDelayPtrInSyn4, numNeurons, };
...
__device__ __constant__ unsigned int d_mergedNeuronUpdateGroupStartID1[] = {1792, 8832, 12928, 14528, 16512, };
__device__ __constant__ unsigned int d_mergedNeuronUpdateGroupStartID2[] = {16896, 19520, };
__device__ __constant__ unsigned int d_mergedNeuronUpdateGroupStartID3[] = {21440, };
__device__ __constant__ unsigned int d_mergedNeuronUpdateGroupStartID4[] = {41728, 43392, 45120, };
__device__ __constant__ unsigned int d_mergedNeuronUpdateGroupStartID5[] = {45440, };
__device__ __constant__ unsigned int d_mergedNeuronUpdateGroupStartID6[] = {60992, };
__device__ __constant__ unsigned int d_mergedNeuronUpdateGroupStartID7[] = {82624, };
__device__ __constant__ unsigned int d_mergedNeuronUpdateGroupStartID8[] = {157568, };
__device__ __constant__ unsigned int d_mergedNeuronUpdateGroupStartID9[] = {162112, };
...
extern "C" __global__ void updateNeuronsKernel(float t)
 {
    ...
    if(id >= 21440 && id < 41728) {
        ...
        if(lid < group->numNeurons) {
            ...
            // current source 0
             {
                if (t > 600 && t<1600)
                   Isyn += 0.001f*(2.00000000000000000e+02f);
                else 
                   Isyn += 0;
    ...
    if(id >= 157568 && id < 162112) {
        ...
        if(lid < group->numNeurons) {
            ...
            // calculate membrane potential
            if (lRefracTime <= 0.0f) {
              scalar alpha = ((Isyn + (4.90999996662139893e-01f)) * (4.00000000000000000e+01f)) + (-7.00000000000000000e+01f);
              lV = alpha - ((9.95012479192682320e-01f) * (alpha - lV));
            }
            else {
              lRefracTime -= DT;
    ...
    if(id >= 162112 && id < 213888) {
        ...
        if(lid < group->numNeurons) {
            ...
            // current source 0
             {
                if (t > 600 && t<1600)
                   Isyn += 0.001f*(5.00000000000000000e+02f);
                else 
                   Isyn += 0;
