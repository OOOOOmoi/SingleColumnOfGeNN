...
EXPORT_FUNC void pushMergedNeuronUpdate5recordSpkToDevice(unsigned int idx, uint32_t* value);
...
EXPORT_FUNC void pushMergedNeuronUpdate6recordSpkToDevice(unsigned int idx, uint32_t* value);
...
EXPORT_FUNC void pushMergedNeuronUpdate7recordSpkToDevice(unsigned int idx, uint32_t* value);
