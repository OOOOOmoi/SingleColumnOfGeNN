...
# 示例用法
file_path = "/home/yangjinhao/GeNN/genn-master/userproject/SingleColumn/output_voltage/P23.st"  # 替换为实际文件路径
...
# 绘制膜电位曲线并保存结果
output_file = f"/home/yangjinhao/GeNN/genn-master/userproject/SingleColumn/output_voltage/Fig/P23_{random_label}.png"  # 可选，若不保存图像则设为 None
